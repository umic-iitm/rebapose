...
def convert_keypoint_definition(keypoints, pose_det_dataset,
    ...
    if pose_lift_dataset in ['h36m', 'h3wb']:
        ...
        elif pose_det_dataset in ['Keypoint_reba']:
            keypoints_new[:, 7] = (keypoints[:, 2] + keypoints[:, 10]) / 2
            keypoints_new[:, [0, 1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14, 15, 16]] = \
            keypoints[:, [10, 11, 13, 15, 9, 12, 14, 2, 1, 0, 3, 5, 7, 4, 6, 8]]
